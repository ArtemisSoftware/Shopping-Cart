...
import com.artemissoftware.shoppingcart.test.models.MockData.SINGLE_IMAGE_FILE
...
private object MockData {
    ...
    const val SINGLE_IMAGE_FILE = IMAGES_FOLDER + "image.json"
...
enum class ServerMockResponse(val path: String, val file: String){
    SINGLE_IMAGE(path = "/api/?id=1108880", file = SINGLE_IMAGE_FILE),
