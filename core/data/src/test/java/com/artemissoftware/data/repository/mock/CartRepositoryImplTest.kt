package com.artemissoftware.data.repository.mock

import assertk.assertThat
import assertk.assertions.hasSize
import assertk.assertions.isEqualTo
import assertk.assertions.isTrue
import com.artemissoftware.data.TestData.emptyImagesDto
import com.artemissoftware.data.TestData.getProduct
import com.artemissoftware.data.TestData.imageDto
import com.artemissoftware.data.mapper.toEntity
import com.artemissoftware.data.repository.CartRepositoryImpl
...
internal class CartRepositoryImplTest{
    ...
    fun `Search a product, return error`() = runBlocking {
        ...
        coEvery { pixabayApiSource.getImages(searchQuery = any()) } throws mockk<RuntimeException>()
